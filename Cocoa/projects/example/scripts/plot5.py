...
#DELETE TMP FILES
subprocess.Popen("rm .VM_P5_TMP[0-9].*", shell=True, cwd=".")
...
chaindir=r'.'
root_chains = ('EXAMPLE_MCMC3','EXAMPLE_POLY3')
...
param_3d = None
g.triangle_plot(['.VM_P5_TMP1',root_chains[1]],parameter,
...
legend_labels=['Roman O - MCMC','Roman O - Poly'],legend_loc=(0.58,0.765),
imax_shaded=0)
g.export()
