...
#DELETE TMP FILES
subprocess.Popen("rm .VM_P3_TMP[0-9].*", shell=True, cwd=".")
...
chaindir=r'.'
root_chains = ('EXAMPLE_POLY1','EXAMPLE_POLY1V2')
...
param_3d = None
g.triangle_plot(['.VM_P3_TMP1','.VM_P3_TMP2'],parameter,
...
legend_labels=['Pantheon - Poly - 128','Pantheon - Poly - 256'],legend_loc=(0.58,0.79),
imax_shaded=0)
g.export()
