...
root_chains = ('EXAMPLE_MCMC1', 'EXAMPLE_MCMC2', 'EXAMPLE_MCMC3')
...
param_3d = None
g.triangle_plot(['.VM_P1_TMP1','.VM_P1_TMP2','.VM_P1_TMP3'],parameter,
...
legend_labels=['Pantheon + Planck 50 < l < 1100 + $\\tau$ prior','Roman C + Planck 50 < l < 1100 + $\\tau$ prior','Roman O + Planck 50 < l < 1100 + $\\tau$ prior'],legend_loc=(0.39,0.795),
imax_shaded=0)
g.export()
