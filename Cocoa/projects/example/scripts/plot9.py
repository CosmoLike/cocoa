...
parameter = [u'logA', u'ns', u'thetastar', u'omegabh2', u'omegach2']
...
root_chains = (
  '/projects/example/chains/EXAMPLE_EMUL_MCMC2',
  '/projects/example/chains/EXAMPLE_EMUL_MCMC2'
)
...
p = samples.getParams()
samples.saveAsText(chaindir + '/projects/example/scripts/.VM_plot2_TMP1')
# --------------------------------------------------------------------------------
samples=loadMCSamples(chaindir + root_chains[1],settings=analysissettings)
p = samples.getParams()
samples.saveAsText(chaindir + '/projects/example/scripts/.VM_plot2_TMP2')
# --------------------------------------------------------------------------------
...
g.settings.lab_fontsize=16.5
g.legend_labels=False

param_3d = None
g.triangle_plot(
  [
   chaindir + '/projects/example/scripts/.VM_plot2_TMP2',
   chaindir + '/projects/example/scripts/.VM_plot2_TMP1',
  ],
parameter,
