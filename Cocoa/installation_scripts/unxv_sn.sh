#!/bin/bash
# ------------------------------------------------------------------------------
# unxv_sn.sh: unpack the type-Ia supernova likelihood data into
...
#
# Skipped (return 99) when IGNORE_SN_DATA is set. Reruns are safe: existing
# results are kept unless OVERWRITE_EXISTING_SN_DATA is set. On failure
