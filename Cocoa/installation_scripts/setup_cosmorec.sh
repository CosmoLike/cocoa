#!/bin/bash
# ------------------------------------------------------------------------------
# setup_cosmorec.sh: download CosmoRec (a cosmological recombination code).
#
...
# happens here.
#
# Skipped (return 99) when IGNORE_COSMOREC_CODE is set. Reruns are safe:
# existing results are kept unless OVERWRITE_EXISTING_COSMOREC_CODE is set. On
