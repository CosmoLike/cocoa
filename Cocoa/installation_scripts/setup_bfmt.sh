#!/bin/bash
# ------------------------------------------------------------------------------
# setup_bfmt.sh: download the Baryonic Feedback Model Theory block (bfmt).
#
...
#
# Skipped (return 99) when IGNORE_BFMT_CODE is set. Reruns are safe: existing
# results are kept unless OVERWRITE_EXISTING_BFMT_CODE is set. On failure
