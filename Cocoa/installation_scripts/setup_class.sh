#!/bin/bash
# ------------------------------------------------------------------------------
# setup_class.sh: download CLASS (the alternative Boltzmann code) and its
# classy wrapper.
#
...
#
# Skipped (return 99) when IGNORE_CLASS_CODE is set. Reruns are safe: existing
# results are kept unless OVERWRITE_EXISTING_CLASS_CODE is set. On failure
