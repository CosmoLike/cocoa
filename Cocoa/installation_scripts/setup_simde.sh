#!/bin/bash
# ------------------------------------------------------------------------------
# setup_simde.sh: download the SIMDe header library (SIMD portability).
#
...
# happens here.
#
# Skipped (return 99) when IGNORE_SIMDE_CODE is set. Reruns are safe: existing
# results are kept unless OVERWRITE_EXISTING_SIMDE_CODE is set. On failure
