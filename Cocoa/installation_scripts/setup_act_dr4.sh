#!/bin/bash
# ------------------------------------------------------------------------------
# setup_act_dr4.sh: download the ACT DR4 CMB likelihood code (pyactlike).
#
...
# happens here.
#
# Skipped (return 99) when IGNORE_ACTDR4_CODE is set. Reruns are safe:
# existing results are kept unless OVERWRITE_EXISTING_ACTDR4_CMB_CODE is set.
