#!/bin/bash
# ------------------------------------------------------------------------------
# compile_lipop.sh: build and install the Planck LoLLiPoP/HiLLiPoP
# likelihoods.
#
...
#
# Skipped (return 99) when IGNORE_LIPOP_LIKELIHOOD_CODE is set. On failure
...
ptop "COMPILING HILLIPOP LIKELIHOOD" || { unset_all; return 1; }
