#!/bin/bash
# ------------------------------------------------------------------------------
# compile_nautilus_sampler.sh: build and install the Nautilus nested sampler.
#
...
#
# Skipped (return 99) when IGNORE_NAUTILUS_SAMPLER_CODE is set. On failure
...
ptop "COMPILING NAUTILUS SAMPLER" || { unset_all; return 1; }
