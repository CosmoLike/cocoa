#!/bin/bash
# ------------------------------------------------------------------------------
# setup_fbre.sh: download the FLAMINGO baryonic response emulator (fbre).
#
...
# happens here.
#
# Skipped (return 99) when IGNORE_FBRE_CODE is set. Reruns are safe: existing
# results are kept unless OVERWRITE_EXISTING_FBRE_CODE is set. On failure
