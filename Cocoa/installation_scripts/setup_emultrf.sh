#!/bin/bash
# ------------------------------------------------------------------------------
# setup_emultrf.sh: download the machine-learning emulator code (emultrf).
#
...
# happens here.
#
# Skipped (return 99) when IGNORE_EMULTRF_CODE is set. Reruns are safe:
# existing results are kept unless OVERWRITE_EXISTING_EMULTRF_CODE is set. On
