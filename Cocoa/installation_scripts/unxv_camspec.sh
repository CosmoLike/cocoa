#!/bin/bash
# ------------------------------------------------------------------------------
# unxv_camspec.sh: unpack the Planck CamSpec likelihood data into
...
#
# Skipped (return 99) when IGNORE_CAMSPEC_CMB_DATA is set. Reruns are safe:
# existing results are kept unless OVERWRITE_EXISTING_CAMPSPEC_CMB_DATA is
