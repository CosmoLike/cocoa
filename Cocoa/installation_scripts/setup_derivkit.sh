#!/bin/bash
# ------------------------------------------------------------------------------
# setup_derivkit.sh: download DerivKit (a numerical-derivative toolkit).
#
...
#
# Skipped (return 99) when IGNORE_DERIVKIT_CODE is set. Reruns are safe:
# existing results are kept unless OVERWRITE_EXISTING_DERIVKIT_CODE is set. On
