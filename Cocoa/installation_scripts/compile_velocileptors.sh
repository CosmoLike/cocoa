#!/bin/bash
# ------------------------------------------------------------------------------
# compile_velocileptors.sh: build and install velocileptors (Lagrangian
# perturbation theory for redshift-space spectra).
#
...
#
# Skipped (return 99) when IGNORE_VELOCILEPTORS_CODE is set. On failure
