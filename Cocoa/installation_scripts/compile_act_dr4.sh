#!/bin/bash
# ------------------------------------------------------------------------------
# compile_act_dr4.sh: build and install the ACT DR4 CMB likelihood code
# (pyactlike).
#
...
#
# Skipped (return 99) when IGNORE_ACTDR4_CODE is set. On failure error() names
...
ptop "COMPILING ACT-DR4" || { unset_all; return 1; }
...
pbottom "COMPILING ACT-DR4" || { unset_all; return 1; }
