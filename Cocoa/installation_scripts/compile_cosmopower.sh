#!/bin/bash
# ------------------------------------------------------------------------------
# compile_cosmopower.sh: build and install CosmoPower (neural-network
# emulators for CMB and matter power spectra).
#
...
#
# Skipped (return 99) when IGNORE_COSMOPOWER_CODE is set. On failure error()
...
ptop "COMPILING COSMOPOWER" || { unset_all; return 1; }
...
pbottom "COMPILING COSMOPOWER" || { unset_all; return 1; }
