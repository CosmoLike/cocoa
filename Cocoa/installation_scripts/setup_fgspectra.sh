#!/bin/bash
# ------------------------------------------------------------------------------
# setup_fgspectra.sh: download fgspectra (foreground spectra used by CMB
# likelihoods).
#
...
#
# Skipped (return 99) when IGNORE_FGSPECTRA_CODE is set. Reruns are safe:
# existing results are kept unless OVERWRITE_EXISTING_FGSPECTRA_CODE is set.
...
# ----------------------------------------------------------------------------
# ----------------------------------------------------------------------------
if [ -n "${IGNORE_FGSPECTRA_CODE:-}" ]; then
  return 99
fi
