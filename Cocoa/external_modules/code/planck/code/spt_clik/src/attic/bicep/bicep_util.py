...
def read_data_products_bandpowers(exp = 'bicep1'):
    ...
    try:
        ...
        print 'bicep2 data products available at http://bicepkeck.org/bicep2_2014_release'
