...
As long as your new CAMB/CLASS makefiles are not altered to the extent that Cocoa [patch files]([https://en.wikipedia.org/wiki/Patch_(Unix)](https://github.com/CosmoLike/cocoa/tree/dev/cocoa_installation_libraries/camb_changes)) fail, that is all what is needed.
