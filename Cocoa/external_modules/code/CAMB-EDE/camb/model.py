...
class CAMBparams(F2003Class):
    ...
    def set_H0_for_theta(self, theta, cosmomc_approx=False, theta_H0_range=(50, 100), est_H0=67.0,
    ...
    def set_cosmology(self, H0: Optional[float] = None, ombh2=0.022, omch2=0.12, omk=0.0,
                      ...
                      Alens=1.0, bbn_predictor: Union[None, str, bbn.BBNPredictor] = None, theta_H0_range=(50, 100)):
        r"""
