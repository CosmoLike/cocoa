    ...
    else if (DarkEneryModel == 'EARLYDARKENERGY') then
        allocate (TEarlyDarkEnergy::P%DarkEnergy)
    else if (DarkEneryModel == 'WEDEFLUID') then
        allocate(TWEDEFluid::P%DarkEnergy)
    else
