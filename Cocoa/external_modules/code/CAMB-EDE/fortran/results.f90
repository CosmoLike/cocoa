    ...
    ! Return 8*pi*G*rho_no_de*a**4
    ! where rho_no_de includes everything except dark energy,
    ! namely curvature, CDM, baryons, photons and neutrinos (massive and massless)
    class(CAMBdata) :: this
    real(dl), intent(in) :: a
    ...
    !  JVR - Return 8*pi*G*rho_matter*a**4
    ! where rho_matter includes cdm, baryons and massive neutrinos
    class(CAMBdata) :: this
    real(dl), intent(in) :: a
    real(dl) grhoa2, rhonu
    integer :: nu_i
    ...
    ! JVR - Returns 8*pi*G*rho_rad*a**4
    ! where rho_rad includes photons and massless neutrinos
    class(CAMBdata) :: this
    real(dl), intent(in) :: a
    real(dl) grhoa2, rhonu
    ...
    !  JVR - Returns radiation pressure
    class(CAMBdata) :: this
    real(dl), intent(in) :: a
