...
// ------------------------------------------------------------------------
// look-up tables for angular correlation functions - all angles in radian!
