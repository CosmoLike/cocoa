...
export COSMOLIKE_GIT_COMMIT="4cbc66f02babd800529c2a527c48a1d4a78718b5"
...
export EMULTRF_GIT_COMMIT="dd55722e33498242755d8e1cbdd8b3966bba310f"
...
export LSST_Y1_COMMIT="0d44402b18d606507fed72ee0de8b3a9c4627770"
...
#COMMIT: if unset, load the specified commit
export DES_Y3_COMMIT="6935ebda865a4003945db937f76664bdc99a9940"
#BRANCH: if unset, load the specified TAG
...
#COMMIT: if unset, load the specified commit
export ROMAN_REAL_COMMIT="c39a4e3c12eae3787160ede8deb2bca5bbf5dff7"
#BRANCH: if unset, load the specified TAG
