...
- [Closed tickets](#closed-tickets) — a pointer; the archive lives in
...
Closed tickets are archived in
[`backlog-closed.md`](backlog-closed.md), grouped by subject. Nothing
there is open work. To reopen one, move its section back under
[Open tickets](#open-tickets) and add its `- OPEN` index line.
