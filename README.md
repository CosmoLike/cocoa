...
(**Warning**) This method is slow, not advisable. It does, however, provide the experienced user more flexibility in choosing the compiler, python and package version. Another advantage to the experience user lies in the fact that OpenMPI given by conda::forge is incompatible with [Infiniband]((https://github.com/conda-forge/openmpi-feedstock/issues/38)).  
