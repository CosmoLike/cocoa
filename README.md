...
PS: To be fair, we are quite loose on the installation procedures for MacOS (see appendix: [Prerequisites for MacOS](https://github.com/CosmoLike/cocoa#prerequisites-for-macos)) because our group never runs production results in such an environment.
