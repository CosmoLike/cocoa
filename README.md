...
- **Emcee**:
  ...
  Conclusion: `Emcee` requires $\sim 10$ more evaluations in this case, but the number of evaluations per MPI walker (assuming one MPI worker per walker) is reduced by $\sim 10$.
